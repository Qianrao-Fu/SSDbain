...
#========================================================================================")
Res<-SSDANOVA_robust(hyp1="mu1=mu2=mu3",hyp2="Ha",f1=0,f2=0.25,skews=c(1.75,1.75,1.75),kurts=c(5.89,5.89,5.89),var=c(1.5,0.75,0.75),BFthresh=3,eta=0.8,T=10000,seed=10)
N<-Res[[1]][1]
eta1<-Res[[2]][[1]][[1]]
eta2<-Res[[2]][[1]][[2]]
