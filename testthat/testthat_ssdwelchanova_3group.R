...
#========================================================================================")
Res<-SSDANOVA(hyp1<-"mu1=mu2=mu3",hyp2="mu1>mu2>mu3",f1=0,f2=0.25,var=NULL,T=10000,BFthresh=3,eta=0.8,type='unequal')
N<-Res[[1]][1]
eta1<-Res[[2]][[1]][[1]]
eta2<-Res[[2]][[1]][[2]]
...
##Calculate eta1 and eta2 in SSDANOVA with the final sample size
m<-m1
