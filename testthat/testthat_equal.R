...
#========================================================================================")
Res<-SSDANOVA(hyp1<-"mu1=mu2>mu3",hyp2="mu2=mu3>mu1",f1=0.1,f2=0.1,var=NULL,T=10000,BFthresh=3,eta=0.8,type='equal')
N<-Res[[1]][1]
eta1<-Res[[2]][[1]][[1]]
eta2<-Res[[2]][[1]][[2]]
...
##Calculate eta1 and eta2 in SSDANOVA software with the final sample size N
m<-m1
