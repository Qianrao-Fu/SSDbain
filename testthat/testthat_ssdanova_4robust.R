...
#========================================================================================")
Res<-SSDANOVA_robust(hyp1="mu1>mu2>mu3>mu4",hyp2="mu2>mu3>mu1>mu4",f1=0.25,f2=0.25,skews=c(0,0,0,0),kurts=c(0,0,0,0),var=c(4/3,2/3,4/3,2/3),BFthresh=3,eta=0.8,T=10000,seed=10)
N<-Res[[1]][1]
eta1<-Res[[2]][[1]][[1]]
eta2<-Res[[2]][[1]][[2]]
