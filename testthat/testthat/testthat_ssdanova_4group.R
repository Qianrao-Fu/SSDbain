...
#========================================================================================")
 ...
 #Res<-SSDANOVA(hyp1<-"mu1=mu2=mu3=mu4",hyp2="mu1>mu2>mu3>mu4",f1=0,f2=0.25,var=NULL,T=10000,BFthresh=3,eta=0.8,type='equal')
 #N<-Res[[1]][1]
# eta1<-Res[[2]][[1]][[1]]
# eta2<-Res[[2]][[1]][[2]]
...
test_that("SSDANOVA", {expect_equal(eta1,eta_seed1 ,tolerance = .02)})
test_that("SSDANOVA", {expect_equal(eta2,eta_seed2,tolerance = .02)})
